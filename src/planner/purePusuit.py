...
class PurePursuitPlanner:
    ...
    Example Planner
    """
    def __init__(self, wheelbase, map_manager, lookahead=2.0, max_reacquire=20.):
    ...
    def plan(self, obs, id=0, gain = 0.15):
        """
        gives actuation given observation
        """
        position = np.array([obs['poses_x'][id], obs['poses_y'][id]])
        lookahead_distance = self.lookahead + gain * obs['linear_vels_x'][0]
